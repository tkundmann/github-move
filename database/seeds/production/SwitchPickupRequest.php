...
class SwitchPickupRequest extends Seeder
{
		/**
     ...
     */
		...
		$site = Site::where('code', '=', 'switch')->first();

		$site->features()->attach([$featureHasPickupRequest->id]);

		$pickupRequestConfiguration = array (
			'password' => Hash::make('sw03242018sar!'),
			'title' => 'Sipi Asset Recovery/Switch Pickup Request',
			...
			'email_from' => 'SARswitch@sipiar.com',
			'email_bcc' => 'SARswitch@sipiar.com;tony@lynch2.com',
		...
		$pickupRequestEquipListConfiguration = array (
			0 =>
				array (
					'name' => 'Equipment List',
					'filename' => 'Switch_EquipmentList.xls',
					'url' => 'https://belmont-sipi-assets.s3.amazonaws.com/switch/pickup_request/equipment_list_templates/Switch_EquipmentList.xls',
				),
			);
