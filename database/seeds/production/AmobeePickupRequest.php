...
class AmobeePickupRequest extends Seeder
{
		/**
     ...
     */
		...
		$pickupRequestConfiguration = array (
			'password' => Hash::make('amo03052018sar&'),
			'title' => 'Sipi Asset Recovery/Amobee Pickup Request',
			...
			'email_from' => 'SARAmobee@sipiar.com',
			'email_bcc' => 'SARAmobee@sipiar.com;tony@lynch2.com',
