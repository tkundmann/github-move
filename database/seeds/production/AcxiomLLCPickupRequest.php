...
class AcxiomLLCPickupRequest extends Seeder
{
		/**
     ...
     */
		...
		$site = Site::where('code', '=', 'acxiomllc')->first();

		$site->features()->attach([$featureHasPickupRequest->id]);

		$pickupRequestConfiguration = array (
			'password' => Hash::make('acx020521sar!'),
			'title' => 'Sipi Asset Recovery/Acxiom LLC Pickup Request',
			...
			'email_from' => 'saracxiomllc@sipiar.com',
			'email_bcc' => 'saracxiomllc@sipiar.com;tony@lynch2.com;stan.henninger@acxiom.com',
		...
		$pickupRequestEquipListConfiguration = array (
			array (
					'name' => 'Equipment List',
					'filename' => 'AcxiomLLC_EquipmentList_US.xls',
					'url' => 'https://belmont-sipi-assets.s3.amazonaws.com/acxiomllc/pickup_request/equipment_list_templates/AcxiomLLC_EquipmentList_US.xls',
				)
			);
