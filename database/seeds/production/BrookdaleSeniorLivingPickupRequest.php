...
class BrookdaleSeniorLivingPickupRequest extends Seeder
{
		/**
		...
		*/
		...
		$pickupRequestConfiguration = array (
			'password' => Hash::make('brk032521sar$'),
			'title' => 'Sipi Asset Recovery/Brookdale Senior Living Pickup Request',
			...
			'email_from' => 'sarbrookdale@sipiar.com',
			'email_bcc' => 'sarbrookdale@sipiar.com;tony@lynch2.com',
		...
		$pickupRequestEquipListConfiguration = array (
			array (
					'name' => 'Equipment List',
					'filename' => 'BrookdaleSeniorLiving_EquipmentList.xls',
					'url' => 'https://belmont-sipi-assets.s3.amazonaws.com/brookdale/pickup_request/equipment_list_templates/BrookdaleSeniorLiving_EquipmentList.xls',
				)
			);
