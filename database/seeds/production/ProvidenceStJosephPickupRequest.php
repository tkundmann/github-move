...
class ProvidenceStJosephPickupRequest extends Seeder
{
		/**
     ...
     */
		...
		$pickupRequestConfiguration = array (
			'password' => Hash::make('pstj0121020sar!'),
			'title' => 'Sipi Asset Recovery/Providence St. Joseph Health Pickup Request',
			...
			'email_bcc' => 'sarprovidence@sipiar.com;tony@lynch2.com;kathleen.finley@providence.org;sherie.drew@providence.org;scott.dambrauckas@providence.org',
		...
		$pickupRequestEquipListConfiguration = array (
			array (
					'name' => 'Equipment List',
					'filename' => 'Providence_EquipmentList.xls',
					'url' => 'https://belmont-sipi-assets.s3.amazonaws.com/providencestjoseph/pickup_request/equipment_list_templates/Providence_EquipmentList.xls',
				)
			);
