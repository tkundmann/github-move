     ...
     */
		...
		$pickupRequestEquipListConfiguration = array (
			0 =>
				array (
					'name' => 'Equipment List',
					'filename' => 'FATCO_EquipmentList.xls',
					'url' => 'https://belmont-sipi-assets.s3.amazonaws.com/firstamericantitlecompany/pickup_request/equipment_list_templates/FATCO_EquipmentList.xls',
				),
			);
