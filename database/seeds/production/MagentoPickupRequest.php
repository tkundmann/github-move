...
class MagentoPickupRequest extends Seeder
{
		/**
     ...
     */
		...
		$pickupRequestConfiguration = array (
			'password' => Hash::make('mag05152017sar$'),
			'title' => 'Sipi Asset Recovery/Magento Pickup Request',
			...
			'email_from' => 'SARmagento@sipiar.com',
			'email_bcc' => 'SARmagento@sipiar.com;tony@lynch2.com',
		...
		$pickupRequestEquipListConfiguration = array (
			0 =>
				array (
					'name' => 'Equipment List',
					'filename' => 'Magento_EquipmentList.xls',
					'url' => 'https://belmont-sipi-assets.s3.amazonaws.com/magento/pickup_request/equipment_list_templates/Magento_EquipmentList.xls',
				),
			);
