...
class WhiteCapPickupRequest extends Seeder
{
		/**
		...
		*/
		...
		$pickupRequestEquipListConfiguration = array (
			array (
					'name' => 'Equipment List',
					'filename' => 'WhiteCap_EquipmentList_US.xls',
					'url' => 'https://belmont-sipi-assets.s3.amazonaws.com/whitecap/pickup_request/equipment_list_templates/WhiteCap_EquipmentList_US.xls',
				)
			);
