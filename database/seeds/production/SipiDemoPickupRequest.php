...
class SipiDemoPickupRequest extends Seeder
{
		/**
     ...
     */
		...
		$pickupRequestConfiguration = array (
			'password' => Hash::make('demo11292017sar$'),
			'title' => 'Sipi Asset Recovery Demo Pickup Request',
			...
			'email_from' => 'SARdemo@sipiar.com',
			'email_bcc' => 'SARdemo@sipiar.com;tony@lynch2.com',
		...
		$pickupRequestEquipListConfiguration = array (
			0 =>
				array (
					...
					'filename' => 'SipiDemo_EquipmentList_US.xls',
					'url' => 'https://belmont-sipi-assets.s3.amazonaws.com/sipidemo/pickup_request/equipment_list_templates/SipiDemo_EquipmentList_US.xls',
				),
			1 =>
				array (
					'name' => 'EMEA Equipment List',
					'filename' => 'SipiDemo_EquipmentList_EMEA.xls',
					'url' => 'https://belmont-sipi-assets.s3.amazonaws.com/sipidemo/pickup_request/equipment_list_templates/SipiDemo_EquipmentList_EMEA.xls',
				),
			);
