...
class FATCOPickupRequestAddressSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        $site = Site::where('code', '=', 'firstamericantitlecompany')->first();
        ...
        DB::table('pickup_request_address')->insert([
            [
                ...
                'company_name' => 'First American Title Company',
                'company_division' => null,
                'contact_name' => Crypt::encrypt(''),
                'contact_phone_number' => Crypt::encrypt(''),
                'contact_address_1' => Crypt::encrypt('2707 COLBY AVE'),
                'contact_address_2' => Crypt::encrypt('STE 601'),
                'contact_city' => 'EVERETT',
                'contact_state' => 'WA',
                'contact_zip' => '98201',
                'contact_country' => 'USA',
