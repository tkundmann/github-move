...
class AmericanCancerSocietyPickupRequest extends Seeder
{
		/**
     ...
     */
		...
		$site = Site::where('code', '=', 'americancancersociety')->first();

		$site->features()->attach([$featureHasPickupRequest->id]);

		$pickupRequestConfiguration = array (
			'password' => Hash::make('acs062420sar!'),
			'title' => 'Sipi Asset Recovery/American Cancer Society Pickup Request',
		...
		$pickupRequestEquipListConfiguration = array (
			array (
					'name' => 'Equipment List',
					'filename' => 'ACS_EquipmentList.xls',
					'url' => 'https://belmont-sipi-assets.s3.amazonaws.com/americancancersociety/pickup_request/equipment_list_templates/ACS_EquipmentList.xls',
				)
			);
