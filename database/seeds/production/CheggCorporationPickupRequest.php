...
class CheggPickupRequest extends Seeder
{
		/**
     ...
     */
		...
		$pickupRequestConfiguration = array (
			...
			'email_from' => 'sarchegg@sipiar.com',
			'email_bcc' => 'sarchegg@sipiar.com;tony@lynch2.com',
		...
		$pickupRequestEquipListConfiguration = array (
			array (
					'name' => 'Equipment List',
					'filename' => 'Chegg_EquipmentList.xls',
					'url' => 'https://belmont-sipi-assets.s3.amazonaws.com/chegg/pickup_request/equipment_list_templates/Chegg_EquipmentList.xls',
				)
			);
