...
class KaplanIncPickupRequest extends Seeder
{
		/**
     ...
     */
		...
		$site = Site::where('code', '=', 'kaplan')->first();

		$site->features()->attach([$featureHasPickupRequest->id]);

		$pickupRequestConfiguration = array (
			'password' => Hash::make('kaplan06112020sar!'),
			'title' => 'Sipi Asset Recovery/Kaplan Inc. Pickup Request',
			...
			'email_from' => 'sarkaplan@sipiar.com',
			'email_bcc' => 'sarkaplan@sipiar.com;tony@lynch2.com',
		...
		$pickupRequestEquipListConfiguration = array (
			array (
					'name' => 'Equipment List',
					'filename' => 'Kaplan_EquipmentList.xls',
					'url' => 'https://belmont-sipi-assets.s3.amazonaws.com/kaplan/pickup_request/equipment_list_templates/Kaplan_EquipmentList.xls',
				)
			);
