...
class WhiteCapPickupRequestAddressSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        DB::table('pickup_request_address')->insert([
            [
                'site_id' => $site->id,
                'name' => 'White Cap - Hamilton',
                'company_name' => 'White Cap',
                'company_division' => null,
                'contact_name' => Crypt::encrypt(''),
                'contact_phone_number' => Crypt::encrypt(''),
                'contact_address_1' => Crypt::encrypt('9474 Sutton Pl'),
                'contact_address_2' => Crypt::encrypt(''),
                'contact_city' => 'Hamilton',
                'contact_state' => 'OH',
                'contact_zip' => '45011',
                'contact_country' => 'USA',
