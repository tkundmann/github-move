...
class PayPalPickupRequest extends Seeder
{
		/**
     ...
     */
		...
		$pickupRequestConfiguration = array (
			'password' => Hash::make('pp04272017sar!'),
			'title' => 'Sipi Asset Recovery/PayPal Pickup Request',
			...
			'email_from' => 'SARPaypal@sipiar.com',
			'email_bcc' => 'SARPaypal@sipiar.com;tony@lynch2.com',
		...
		$pickupRequestEquipListConfiguration = array (
			0 =>
				array (
					'name' => 'Equipment List',
					'filename' => 'Paypal_EquipmentList.xls',
					'url' => 'https://belmont-sipi-assets.s3.amazonaws.com/paypal/pickup_request/equipment_list_templates/Paypal_EquipmentList.xls',
				),
			);
