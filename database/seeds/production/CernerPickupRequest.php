...
class CernerPickupRequest extends Seeder
{
		/**
     ...
     */
		...
		$pickupRequestConfiguration = array (
			'password' => Hash::make('cn03222017sar!'),
			'title' => 'Sipi Asset Recovery/Cerner Pickup Request',
			...
			'email_from' => 'SARCerner@sipiar.com',
			'email_bcc' => 'SARCerner@sipiar.com;ian.brennan@cerner.com;tony@lynch2.com',
		...
		$pickupRequestEquipListConfiguration = array (
			0 =>
				array (
					'name' => 'Equipment List',
					'filename' => 'Cerner_EquipmentList.xls',
					'url' => 'https://belmont-sipi-assets.s3.amazonaws.com/cerner/pickup_request/equipment_list_templates/Cerner_EquipmentList.xls',
				),
			);
