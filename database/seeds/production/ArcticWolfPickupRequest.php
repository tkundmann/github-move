...
class ArcticWolfPickupRequest extends Seeder
{
		/**
     ...
     */
		...
		$site = Site::where('code', '=', 'arcticwolf')->first();

		$site->features()->attach([$featureHasPickupRequest->id]);

		$pickupRequestConfiguration = array (
			'password' => Hash::make('awn020521sar!'),
			'title' => 'Sipi Asset Recovery/Arctic Wolf Networks Pickup Request',
			...
			'email_from' => 'sararcticwolf@sipiar.com',
			'email_bcc' => 'sararcticwolf@sipiar.com;tony@lynch2.com;adam.gutzmer@arcticwolf.com',
		...
		$pickupRequestEquipListConfiguration = array (
			array (
					'name' => 'Equipment List',
					'filename' => 'ArcticWolf_EquipmentList_US.xls',
					'url' => 'https://belmont-sipi-assets.s3.amazonaws.com/arcticwolf/pickup_request/equipment_list_templates/ArcticWolf_EquipmentList_US.xls',
				)
			);
