...
class AmericanCancerSocietyPickupRequestAddressSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        DB::table('pickup_request_address')->insert([
            [
                'site_id' => $site->id,
                'name' => 'American Cancer Society - Oklahoma City',
                'company_name' => 'American Cancer Society',
                'company_division' => null,
                'contact_name' => Crypt::encrypt(''),
                'contact_phone_number' => Crypt::encrypt(''),
                'contact_address_1' => Crypt::encrypt('6525 N Meridian Ave'),
