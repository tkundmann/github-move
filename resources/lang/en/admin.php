    ...
    */
    ...
    'file' => [
        ...
        'create' => [
            ...
            'shipment' => 'Shipment Lot Number',
            'file_created' => 'File created.',
            'success_file_upload' => 'The following file(s) were successfully uploaded for the selected Site (PLACEHOLDER_SITE_TITLE) and File Type (PLACEHOLDER_FILE_TYPE).<br/>Click on the file name to verify successful upload via the PLACEHOLDER_SITE_TITLE Portal.',
